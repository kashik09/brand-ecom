  ...
  return (
    <section className="space-y-6">
      ...
      <div className="space-y-4">
        {ORDER.map((code) => {
          ...
          return (
            <div
              key={code}
              className="rounded-xl border p-4 grid md:grid-cols-4 gap-3"
            >
              <div>
              ...
              <div>
                ...
                <input
                  ...
                  value={z.fee}
                  onChange={(e) =>
                    setZone(code, { fee: Number(e.target.value) })
                  }
                />
              </div>
              <div>
      ...
      <div className="flex gap-3">
        <button className="rounded-lg border px-4 py-2" onClick={resetZones}>
          Reset to defaults
        </button>
      </div>

      <p className="text-xs text-gray-500">
        Changes are saved automatically in your browser. Checkout uses these
        values live.
      </p>
    </section>
  );
